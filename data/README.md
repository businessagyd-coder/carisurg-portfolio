...
This repository documents Aiden Daniel's work for the CariSurg Healthcare AI Program — covering Week 0 (Python fundamentals & data cleaning on an emergency triage dataset) and Week 1 (a preliminary AI-assisted triage research proposal).

## Repository Structure

```
carisurg-portfolio/
├── notebooks/   # Week 0 Jupyter notebooks (env setup, cleaning, visualisation)
├── docs/        # Week 1 assignments, literature summary, and final proposal
├── data/        # Dataset info (see data/README.md) — raw data not tracked here
├── src/         # Reserved for future weeks
├── README.md
├── LICENSE
├── requirements.txt
└── .gitignore
...
1. Clone the repo: `git clone https://github.com/businessagyd-coder/carisurg-portfolio.git`
2. Install dependencies: `pip install -r requirements.txt`
3. Open notebooks in `notebooks/` using Jupyter or Google Colab

## Author

Aiden Daniel — CariSurg Healthcare AI Program, Mercer General Hospital
